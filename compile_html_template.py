...
for line in lines:
    ...
    # elif testing and line.strip() == '<script src="/rtpe/highlight/highlight.min.js"></script>':
    #     outlines.append('<script src="/highlight/highlight.min.js"></script>')
    # elif testing and line.strip() == '<link rel="stylesheet" href="/rtpe/highlight/styles/school-book.css">':
